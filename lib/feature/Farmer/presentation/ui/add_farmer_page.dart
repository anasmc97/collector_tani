...
class AddFarmerPage extends StatelessWidget {
  ...
  TextEditingController estimationProductionController =
                                ...
                                children: [
                                  ...
                                  Container(
                                      ...
                                      child: CustomTextFormField(
                                        isNumber: true,
                                        controller:
                                            estimationProductionController,
                                        hintext:
                                            'Masukkan Estimasi Jumlah Produksi',
                                        validator: (value) {
                                          if (value!.trim().isEmpty) {
