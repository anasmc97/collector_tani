                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text('Data Pesanan', style: Theme.of(context).textTheme.headline2!.copyWith(fontWeight: FontWeight.w500, fontSize: 16, color: CustomColors.colorsFontPrimary),
                                ),
                              ),
                              Container(
                                padding: const EdgeInsets.only(top: 8),
                              ...
                              Container(
                                padding: const EdgeInsets.only(top: 8),
                                child: Text('Dikirim Ke', style: Theme.of(context).textTheme.headline2!.copyWith(fontWeight: FontWeight.w500, fontSize: 16, color: CustomColors.colorsFontPrimary),
                                ),
                              ),
                              Container(
                                padding: const EdgeInsets.only(top: 8),
                              ...
                              Container(
                                padding: const EdgeInsets.only(top: 8),
                                child: Text('Nomer Telepon', style: Theme.of(context).textTheme.headline2!.copyWith(fontWeight: FontWeight.w500, fontSize: 16, color: CustomColors.colorsFontPrimary),
                                ),
                              ),
                              Container(
                                padding: const EdgeInsets.only(top: 8),
                              ...
                              Container(
                                padding: const EdgeInsets.only(top: 8),
                                child: Text('Alamat', style: Theme.of(context).textTheme.headline2!.copyWith(fontWeight: FontWeight.w500, fontSize: 16, color: CustomColors.colorsFontPrimary),
                                ),
                              ),
                              Container(
                                padding: const EdgeInsets.only(top: 8),
                              ...
                              Container(
                                padding: const EdgeInsets.only(top: 8),
                                child: Text('Tanggal Kirim', style: Theme.of(context).textTheme.headline2!.copyWith(fontWeight: FontWeight.w500, fontSize: 16, color: CustomColors.colorsFontPrimary),
                                ),
                              ),
                              Container(
                                padding: const EdgeInsets.only(top: 8),
                              ...
                              Container(
                                padding: const EdgeInsets.only(top: 8),
                                child: Text('Harga Pengiriman', style: Theme.of(context).textTheme.headline2!.copyWith(fontWeight: FontWeight.w500, fontSize: 16, color: CustomColors.colorsFontPrimary),
                                ),
                              ),
                              Container(
                                padding: const EdgeInsets.only(top: 8),
